# -*- coding: utf-8 -*-
"""
Created on Thu Feb 21 03:40:40 2019
...
left_output = classifier(encoded_left)
right_output = classifier(encoded_right)
...
def questions_vs_answers():
    ...
    print('Welcome to WILP question suggester')
    test_question = input('Please enter your question:')
    category = input('Choose the category to which the question belongs. Enter the string:')
...
def main():
   questions_vs_answers()
   questions_vs_questions()
